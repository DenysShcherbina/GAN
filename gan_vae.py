...
from keras.layers import Dense, Input, Flatten, Reshape, BatchNormalization, Dropout, Conv2D, LeakyReLU, Lambda
...
# Save our decoder for future usage
keras.saving.save_model(model=decoder, filepath='decoder.keras')
